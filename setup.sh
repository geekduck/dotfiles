...
DOT_FILES=( .zshrc .zshrc.alias .zshrc.git .zshenv .zlogin .zshrc.completions .zshrc.antigen .gitconfig .gitignore .tmux.conf .dir_colors .emacs.d .gemrc .git_templates)
